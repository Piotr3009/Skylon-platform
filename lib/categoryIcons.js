...
export const getCategoryColor = (categoryName = '') => {
  ...
  const colors = {
    demolition: 'bg-rose-50 text-rose-600 border-rose-200',
    groundworks: 'bg-amber-50 text-amber-600 border-amber-200',
    structural: 'bg-slate-50 text-slate-600 border-slate-200',
    external: 'bg-gray-50 text-gray-600 border-gray-200',
    roofing: 'bg-teal-50 text-teal-600 border-teal-200',
    joinery: 'bg-orange-50 text-orange-600 border-orange-200',
    internal: 'bg-zinc-50 text-zinc-600 border-zinc-200',
    carpentry: 'bg-amber-50 text-amber-600 border-amber-200',
    plumbing: 'bg-blue-50 text-blue-600 border-blue-200',
    electrical: 'bg-yellow-50 text-yellow-600 border-yellow-200',
    mechanical: 'bg-cyan-50 text-cyan-600 border-cyan-200',
    plastering: 'bg-stone-50 text-stone-600 border-stone-200',
    flooring: 'bg-neutral-50 text-neutral-600 border-neutral-200',
    finishing: 'bg-emerald-50 text-emerald-600 border-emerald-200',
    specialist: 'bg-red-50 text-red-600 border-red-200'
  }
