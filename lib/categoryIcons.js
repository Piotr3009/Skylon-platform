...
export const getCategoryIcon = (categoryName = '') => {
  ...
  const keywords = {
    ...
    roofing: ['roofing', 'roof', 'waterproof'],
...
export const getCategoryColor = (categoryName = '') => {
  ...
  const colors = {
    demolition: 'bg-rose-100 text-rose-700 border-rose-300',
    groundworks: 'bg-amber-100 text-amber-700 border-amber-300',
    structural: 'bg-slate-100 text-slate-700 border-slate-300',
    external: 'bg-gray-100 text-gray-700 border-gray-300',
    roofing: 'bg-teal-100 text-teal-700 border-teal-300',
    joinery: 'bg-orange-100 text-orange-700 border-orange-300',
    internal: 'bg-zinc-100 text-zinc-700 border-zinc-300',
    carpentry: 'bg-amber-100 text-amber-700 border-amber-300',
    plumbing: 'bg-blue-100 text-blue-700 border-blue-300',
    electrical: 'bg-yellow-100 text-yellow-700 border-yellow-300',
    mechanical: 'bg-cyan-100 text-cyan-700 border-cyan-300',
    plastering: 'bg-stone-100 text-stone-700 border-stone-300',
    flooring: 'bg-neutral-100 text-neutral-700 border-neutral-300',
    finishing: 'bg-emerald-100 text-emerald-700 border-emerald-300',
    specialist: 'bg-red-100 text-red-700 border-red-300'
  }
