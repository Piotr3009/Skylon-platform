...
export const getCategoryColor = (categoryName = '') => {
  ...
  const colors = {
    demolition: 'bg-red-200 text-red-800 border-red-400',
    groundworks: 'bg-amber-200 text-amber-900 border-amber-400',
    structural: 'bg-slate-200 text-slate-800 border-slate-400',
    external: 'bg-gray-200 text-gray-800 border-gray-400',
    roofing: 'bg-teal-200 text-teal-800 border-teal-400',
    joinery: 'bg-orange-200 text-orange-800 border-orange-400',
    internal: 'bg-zinc-200 text-zinc-800 border-zinc-400',
    carpentry: 'bg-amber-200 text-amber-900 border-amber-400',
    plumbing: 'bg-blue-200 text-blue-800 border-blue-400',
    electrical: 'bg-yellow-200 text-yellow-800 border-yellow-400',
    mechanical: 'bg-cyan-200 text-cyan-800 border-cyan-400',
    plastering: 'bg-stone-200 text-stone-800 border-stone-400',
    flooring: 'bg-neutral-200 text-neutral-800 border-neutral-400',
    finishing: 'bg-emerald-200 text-emerald-800 border-emerald-400',
    specialist: 'bg-red-200 text-red-800 border-red-400'
  }
