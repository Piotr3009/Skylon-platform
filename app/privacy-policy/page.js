  ...
  return (
    <div className="min-h-screen bg-gray-50 py-12 px-4 sm:px-6 lg:px-8">
      <div className="max-w-3xl mx-auto bg-white rounded-lg shadow-md p-8">
        ...
        <p className="text-gray-600 mb-8">Last updated on 14/11/2025</p>
        ...
        <div className="space-y-6 text-gray-700 leading-relaxed">
          ...
          <section>
            ...
            <p>
              We use a third-party service provider, Google Analytics, to collect standard internet log information and details of visitor behavior patterns. We do this to find out things such as the number of visitors to the various parts of the site. This information is only processed in a way that does not identify anyone. We do not make, and do not allow Google to make, any attempt to find out the identities of those visiting our website.
            </p>
          </section>
          ...
          <section>
            <h2 className="text-xl font-bold text-gray-900 mb-3">How We Protect Your Information</h2>
            <p>
          ...
          <section>
            <h2 className="text-xl font-bold text-gray-900 mb-3">Your Acceptance of These Terms</h2>
            <p>
          ...
          <section>
            <h2 className="text-xl font-bold text-gray-900 mb-3">Contacting Us</h2>
            <p>
              If you have any questions about this Privacy Policy, the practices of this site, or your dealings with this site, please contact us using the information on our contact page.
            </p>
          </section>
        </div>
      </div>
