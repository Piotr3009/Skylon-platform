...
export default function PublicProjectPage() {
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <section className="bg-gradient-to-r from-blue-600 to-indigo-600 border-b border-indigo-700">
        <div className="max-w-7xl mx-auto px-4 py-6">
          <div className="flex items-start gap-4">
            ...
            <div className="flex-1">
              ...
              <p className="text-blue-50 mb-3 text-sm leading-relaxed">
                We choose our partners based on comprehensive evaluation criteria. 
                <strong className="text-white"> We don't just accept the lowest bid.</strong>
              </p>
              <div className="grid grid-cols-2 md:grid-cols-5 gap-3">
                <div className="bg-white/10 backdrop-blur-sm rounded-lg px-3 py-2 border border-white/20">
                  ...
                  <p className="text-xs text-blue-100">Excellence in workmanship</p>
                </div>
                ...
                <div className="bg-white/10 backdrop-blur-sm rounded-lg px-3 py-2 border border-white/20">
                  <div className="flex items-center gap-2 mb-1">
                    ...
                    <span className="text-xs font-semibold text-white">Timeliness</span>
                  </div>
                ...
                <div className="bg-white/10 backdrop-blur-sm rounded-lg px-3 py-2 border border-white/20">
                  <div className="flex items-center gap-2 mb-1">
                    ...
                    <span className="text-xs font-semibold text-white">Professionalism</span>
                  </div>
                  <p className="text-xs text-blue-100">Professional conduct</p>
                </div>
                ...
                <div className="bg-white/10 backdrop-blur-sm rounded-lg px-3 py-2 border border-white/20">
                  <div className="flex items-center gap-2 mb-1">
                    ...
                    <span className="text-xs font-semibold text-white">Health & Safety</span>
                  </div>
                  <p className="text-xs text-blue-100">Safety compliance</p>
                </div>
                ...
                <div className="bg-white/10 backdrop-blur-sm rounded-lg px-3 py-2 border border-white/20">
                  ...
                  <p className="text-xs text-blue-100">Competitive value</p>
                </div>
              </div>
            </div>
          </div>
